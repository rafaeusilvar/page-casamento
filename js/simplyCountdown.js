    ...
    Array.prototype.forEach.call(cd, function (countdown) {
      ...
      refresh = function () {
        ...
        if (parameters.plural) {
          ...
          minuteWord =
            minutes > 1 ? parameters.words.minutes + parameters.words.pluralLetter : parameters.words.minutes;

          secondWord =
            seconds > 1 ? parameters.words.seconds + parameters.words.pluralLetter : parameters.words.seconds;
        } else {
